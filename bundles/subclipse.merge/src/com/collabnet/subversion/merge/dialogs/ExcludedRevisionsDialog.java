...
public class ExcludedRevisionsDialog extends TrayDialog {
  ...
  private String[] columnHeaders = {
    Messages.ExcludedRevisionsDialog_revision, Messages.ExcludedRevisionsDialog_url
  };
  private ColumnLayoutData columnLayouts[] = {
    new ColumnWeightData(75, 75, true), new ColumnWeightData(450, 450, true)
  };

  public ExcludedRevisionsDialog(
      Shell shell, String fromUrl, Map<String, Set<String>> excludedRevisions) {
    super(shell);
  ...
  class ExcludedRevision implements Comparable {
    ...
    public boolean equals(Object compareTo) {
      if (compareTo instanceof ExcludedRevision) {
        ...
        return compareToRevision.getRevision().equals(revision)
            && compareToRevision.getUrl().equals(url);
      }
